// This file contains all module and lesson content for the platform.
// You can now edit/add modules here, keeping js/module.js clean.
...
window.modulesData = [
  {
    ...
    description:
      "Learn the core building blocks of PyTorch, including tensors, autograd, and your first complete neural network program.",
    lessons: [
      {
        id: 1,
